...
- **Declarative:** Define what you want, not how to get there. Infrastructure-as-Code configs, YAML manifests, Helm charts — declare your desired state.
- **Configuration Repo:** The single declarative source of truth about your environments lives in a Git repo.
